...
import { Store, Menu, X, LogOut, Sun, Moon } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 w-full border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-[#1a2632] shadow-sm">
      <div className="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-xl font-bold tracking-tight text-[#101418] dark:text-white">
            Mini Merch
          </h2>
        </div>
        ...
        <div className="hidden md:flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300">
            ...
            <span className="px-2 py-0.5 rounded-full bg-gray-100 dark:bg-gray-800 text-xs font-bold uppercase">
              {user.role}
            </span>
          </div>
          <button
