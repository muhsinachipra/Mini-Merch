...
export default function Admin() {
  ...
  const handleDelete = (id) => {
    if (
      confirm(
        "Are you sure you want to delete this product? Action cannot be undone.",
      )
    ) {
      deleteProduct(id);
      ...
      <main className="flex-1 px-6 py-8 lg:px-10">
        <div className="mx-auto max-w-[1440px]">
          ...
          <div className="mb-8 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            <div>
              <h2 className="text-3xl font-black tracking-tight text-[#101418] dark:text-white mb-2">
                Product Moderation
              </h2>
              <p className="text-[#5e758d] dark:text-gray-400 text-base">
                Manage and review all listed products across the marketplace.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
            <div className="rounded-xl bg-white dark:bg-[#1e2730] p-4 shadow-sm border border-gray-100 dark:border-gray-700">
              <p className="text-sm text-[#5e758d] dark:text-gray-400 font-medium">
                Total Products
              </p>
              <p className="text-2xl font-bold text-[#101418] dark:text-white mt-1">
                {products.length}
              </p>
            </div>
            <div className="rounded-xl bg-white dark:bg-[#1e2730] p-4 shadow-sm border border-gray-100 dark:border-gray-700">
              ...
              <table className="w-full min-w-[800px] text-left text-sm whitespace-nowrap">
                <thead>
                  <tr className="bg-gray-50 dark:bg-gray-800 border-b border-[#dae0e7] dark:border-gray-700">
                    <th className="px-6 py-4 font-semibold text-[#101418] dark:text-gray-200 w-24">
                      Thumbnail
                    </th>
                    <th className="px-6 py-4 font-semibold text-[#101418] dark:text-gray-200 w-[30%]">
                      Product Name
                    </th>
                    <th className="px-6 py-4 font-semibold text-[#101418] dark:text-gray-200">
                      Category
                    </th>
                    <th className="px-6 py-4 font-semibold text-[#101418] dark:text-gray-200">
                      Price
                    </th>
                    <th className="px-6 py-4 font-semibold text-[#101418] dark:text-gray-200 w-32 text-right">
                      Actions
                    </th>
                  </tr>
                </thead>
                      ...
                      >
                        ...
                        <td className="px-6 py-3">
                          <div className="flex flex-col">
                            <span className="font-medium text-[#101418] dark:text-white group-hover:text-primary transition-colors line-clamp-1">
                              {product.name}
                            </span>
                            <span className="text-xs text-[#5e758d] dark:text-gray-400">
                              ID: #{product.id}
                            </span>
                          </div>
                        </td>
              ...
              <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
                <div>
                  <p className="text-sm text-[#5e758d] dark:text-gray-400">
                    Showing{" "}
                    <span className="font-medium text-[#101418] dark:text-white">
                      1
                    </span>{" "}
                    to{" "}
                    <span className="font-medium text-[#101418] dark:text-white">
