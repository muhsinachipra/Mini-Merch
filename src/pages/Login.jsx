        ...
        <div className="w-full bg-white dark:bg-[#1e2730] rounded-xl shadow-card border border-gray-100 dark:border-gray-800 overflow-hidden relative">
          ...
          <div className="p-8 pt-6">
            <div className="text-center mb-8">
              <h2 className="text-lg font-semibold text-[#101418] dark:text-white mb-1">
                Welcome back
              </h2>
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-5">
              <div className="space-y-2">
                <label className="block text-sm font-medium text-[#101418] dark:text-gray-200">
                  Email Address
                </label>
              ...
              <div className="flex items-center justify-between mt-1">
                <label className="flex items-center gap-2 cursor-pointer group">
                  <div className="relative flex items-center">
                    <input
                      type="checkbox"
                      className="peer h-4 w-4 rounded border-gray-300 text-primary focus:ring-primary/25 cursor-pointer"
                    />
                  </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100 dark:border-gray-700 text-center">
              <p className="text-sm text-gray-500 dark:text-gray-400">
                ...
                <a
                  href="#"
                  className="font-semibold text-primary hover:text-primary/80 hover:underline transition-colors ml-1"
                >
                  Sign up
                </a>
              </p>
